new function() {
  ...
  var FIELD = // TODO Outgoing when switch to `Date` math.
      { year: 0
      , month: 1
      , day: 2
      , hour: 3
  ...
  function adjust (request, posix, adjustment) {
    ...
    increment = SIGN_OFFSET[sign]; // TODO parseInt.
