...
require("proof")(5, function (equal) {
  ...
  equal(tz("2000-09-03", "%x", "zh_TW"), "2000年09月03日", "date format");
  ...
  equal(tz("2000-09-03 08:05:04", "%c", "zh_TW"), "2000年09月03日 (週日) 08時05分04秒", "long date format morning");
  equal(tz("2000-09-03 23:05:04", "%c", "zh_TW"), "2000年09月03日 (週日) 23時05分04秒", "long date format evening");
});
