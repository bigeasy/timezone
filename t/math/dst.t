...
require("../proof") 13, ({ tz, utc }) ->
  ...
  @equal tz("2010-11-07 03:00", "America/Detroit", "-61 minute", "%c"), "Sun 07 Nov 2010 01:59:00 AM EDT",
  ...
  # Minute by minute within the time zone (TODO: Implement correct timezone acronym).
  @equal tz("2010-11-07 02:00", "America/Detroit", "-30 minutes", "%c"), "Sun 07 Nov 2010 01:30:00 AM EDT",
         "-30 minutes from hour after fall back"
  @equal tz("2010-11-07 02:00", "America/Detroit", "-60 minutes", "%c"), "Sun 07 Nov 2010 01:00:00 AM EDT",
